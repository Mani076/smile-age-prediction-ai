...
class PredictionService:
    ...
    def init_models():
        ...
        # Model paths (look in parent directory)
        import os
        ...
        try:
            ...
            try:
                emotion_model_path = os.path.join(base_path, "emotion_model.h5")
            ...
            # Load smile model
            try:
                smile_model_path = os.path.join(base_path, "smile_model.h5")
                smile_model = tf.keras.models.load_model(smile_model_path, compile=False)
            ...
            if face_cascade.empty():
                print(f"⚠ Face cascade not loaded properly")
            else:
